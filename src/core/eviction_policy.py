...
class EvictionPolicy(ABC):
    ...
    @abstractmethod
    def should_evict(self, entries: Dict[str, CacheEntry], bytes_to_free: int) -> List[str]:
        """Return list of keys whose combined size will free at least bytes_to_free bytes."""
        pass
